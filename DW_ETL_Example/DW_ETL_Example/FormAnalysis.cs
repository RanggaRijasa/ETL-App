...
namespace DW_ETL_Example
{
    public partial class FormAnalysis : Form
    {
        ...
        {
            if (cbReport2.SelectedItem != "All Origin")
            {
                try
                {
                    string cmdText = "CALL GetUserOriginDetails('" + cbReport2.SelectedItem + "');";
                    ...
                    switch (cbReport2.SelectedIndex)
                    {
                        case 1:
                            chart1.Series[0].XValueMember = "username";
                            chart1.Series[0].YValueMembers = "total_harga";
                            break;
                        case 2:
                            chart1.Series[0].XValueMember = "username";
                            chart1.Series[0].YValueMembers = "total_harga";
            ...
            else
            {
                ...
                try
                {
                    string cmdText = "CALL CalculateCumulativeTotal();";
                    ...
                    {
                        case 0:
                            chart1.Series[0].XValueMember = "user_origin";
                            chart1.Series[0].YValueMembers = "cumulative_total";
                            break;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                string cmdText = "CALL GetCumulativeTotalByCatalog();";
                ...
                chart1.Series[0].XValueMember = "ID_catalog";
                chart1.Series[0].YValueMembers = "total_harga";
                chart1.DataBind();
            }
            catch (Exception ex)
